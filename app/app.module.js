...
import EmployeeFilterComponent from './components/vue-components/employee-filter.vue';
...
angular.module('appModule').directive('vEmployeeFilter', (createVueComponent) => {
  return createVueComponent(Vue.component('EmployeeFilterComponent', EmployeeFilterComponent));
});
